...
class helpmenu(commands.Cog):
    ...
    async def help(self, interaction : discord.Interaction, member: discord.Member):
        member.guild.roles
        ...
        await interaction.response.send_message(content="**Attention Needed:** Please update your Verification Channel by using the `/setup` command!", embed=cmds)
